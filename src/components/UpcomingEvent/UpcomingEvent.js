    ...
    <div id="upcomingEvent" className="upcomingEvent">
      <div className="upcomingEvent-container">
        ...
        <p className="upcomingEvent-content">
          {Config.upcomingEvent} <a href={Config.membership}>-DETAILS-</a>
        </p>
        <p className="upcomingEvent-content">
          {Config.upcomingEvent2} <a href={Config.membership}>-DETAILS-</a>
        </p>
        <p className="upcomingEvent-content">
          {Config.upcomingEvent3} <a href={Config.membership}>-DETAILS-</a>
        </p>
