            ...
            <div className="pricing-content">
                ...
                <section className="pricing-container">
                    ...
                    <div className="membertype">
                        ...
                        <p className="membertype-description">description </p>
                        <br />
                        <p className="membertype-price">$20 Joining Fee<br/>+ $40/month<br/>+ $50 NZKF Fee/year</p>
                    </div>
                    <div className="membertype">
                        <h3 className="membertype-title">1 Parent + 1 Child 14 years or under</h3>
                        <p className="membertype-description">description</p>
                        <br />
                        <p className="membertype-price">$60 Joining Fee<br/>+ $110/month<br/>+ $100 NZKF Fee/year</p>
                    </div>
                    <div className="membertype">
                        <h3 className="membertype-title">Family (N person, minimum 2)</h3>
                        <p className="membertype-description">description</p>
                        <br />
                        <p className="membertype-price">$30*N Joining Fee<br/>+ $70*N/month<br/>+ $50*N NZKF Fee/year</p>
                    </div>
                </section>
            </div>
        </div>         
